class MinHeap:
    ...
    def _sink_down(self,index):
        ...
        while True:
            if self._left_child(index) < len(self.heap) and self.heap[self._left_child(index)] < self.heap[min_index]:
                min_index = self._left_child(index)
            
            if self._right_child(index) < len(self.heap) and self.heap[self._right_child(index)] < self.heap[min_index]:
                min_index = self._right_child(index)
